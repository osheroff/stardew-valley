namespace StardewValley.Util
{
	public class LeftRightClickSpamInputSimulator : IInputSimulator
	{
		...
		{
			useToolButtonPressed = leftClickThisFrame;
			useToolButtonReleased = !leftClickThisFrame;
			actionButtonPressed = !leftClickThisFrame;
			leftClickThisFrame = !leftClickThisFrame;
		}
	}
}
