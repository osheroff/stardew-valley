...
namespace StardewValley.Minigames
{
	public class BoatJourney : IMinigame
	{
		...
		public void CreateFlockOfSeagulls(int x, int y, int depth)
		{
			...
			Entity seagull = new Entity(this, "Minigames\\boatJourneyMap", new Rectangle(646, 560, 5, 14), new Vector2(2f, 14f), new Vector2(x, y));
			seagull.numFrames = 8;
			...
			for (int i = 1; i < depth; i++)
			{
				...
				seagull = new Entity(this, "Minigames\\boatJourneyMap", new Rectangle(646, 560, 5, 14), new Vector2(2f, 14f), left);
				seagull.numFrames = 8;
				seagull.currentFrame = Game1.random.Next(0, 8);
				seagull.velocity = velocity + new Vector2(Utility.RandomFloat(-0.001f, 0.001f), Utility.RandomFloat(-0.001f, 0.001f));
				seagull.frameInterval = Utility.RandomFloat(0.1f, 0.15f);
				entities.Add(seagull);
				_seagulls.Add(seagull);
				seagull = new Entity(this, "Minigames\\boatJourneyMap", new Rectangle(646, 560, 5, 14), new Vector2(2f, 14f), right);
				seagull.numFrames = 8;
				seagull.currentFrame = Game1.random.Next(0, 8);
				seagull.velocity = velocity + new Vector2(Utility.RandomFloat(-0.001f, 0.001f), Utility.RandomFloat(-0.001f, 0.001f));
				seagull.frameInterval = Utility.RandomFloat(0.1f, 0.15f);
