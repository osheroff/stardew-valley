...
namespace StardewValley.Buildings
{
	public class PondFishSilhouette
	{
		...
		public void Draw(SpriteBatch b)
		{
			...
			b.Draw(origin: new Vector2(8f, 8f), texture: Game1.objectSpriteSheet, position: Game1.GlobalToLocal(Game1.viewport, draw_position), sourceRectangle: Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, _fishObject.ParentSheetIndex, 16, 16), color: Color.Black * transparency, rotation: angle, scale: 4f * draw_scale, effects: effect, layerDepth: position.Y / 10000f + 1E-06f);
		}
