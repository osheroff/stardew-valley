...
namespace StardewValley.Buildings
{
	public class GreenhouseBuilding : Building
	{
		...
		public virtual void DrawEntranceTiles(SpriteBatch b)
		{
			...
			Vector2 vector_draw_position = Vector2.Zero;
			...
			{
				float draw_layer = 0f;
				vector_draw_position = Game1.GlobalToLocal(Game1.viewport, new Vector2((int)tileX + humanDoor.Value.X - 1, (int)tileY + humanDoor.Value.Y + 1) * 64f);
