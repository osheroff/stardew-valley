...
namespace Force.DeepCloner.Helpers
{
	public abstract class ShallowObjectCloner
	{
		...
		private static ShallowObjectCloner GenerateUnsafeCloner()
		{
			...
			ILGenerator iLGenerator2 = builder.DefineMethod("DoCloneObject", MethodAttributes.Public | MethodAttributes.Virtual, CallingConventions.HasThis, typeof(object), new Type[1]
			{
				typeof(object)
			}).GetILGenerator();
