	...
	public class SteamHelper : SDKHelper
	{
		...
		public void Initialize()
		{
			try
			{
				...
				Console.WriteLine("Steam logged on: " + SteamUser.BLoggedOn());
				if (active)
				{
		...
		private void onEncryptedAppTicketResponse(EncryptedAppTicketResponse_t response, bool ioFailure)
		{
			...
			{
				Console.WriteLine(string.Concat("Failed to retrieve encrypted app ticket: ", response.m_eResult, ", ", ioFailure.ToString()));
				ConnectionFinished = true;
			}
		}
