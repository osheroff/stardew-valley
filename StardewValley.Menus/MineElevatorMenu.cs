...
namespace StardewValley.Menus
{
	public class MineElevatorMenu : IClickableMenu
	{
			...
			: base(0, 0, 0, 0, showUpperRightCloseButton: true)
		{
			...
			elevators.Add(new ClickableComponent(new Rectangle(x, y, 44, 44), string.Concat(0))
			{
				myID = 0,
				rightNeighborID = 1,
			...
			{
				elevators.Add(new ClickableComponent(new Rectangle(x, y, 44, 44), string.Concat(i * 5))
				{
					myID = i,
