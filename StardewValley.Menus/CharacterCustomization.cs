		...
		private void setUpPositions()
		{
			...
			if (Game1.gameMode == 3 && Game1.locations != null && source == Source.Wizard)
			{
				...
				if (pet != null)
				{
					...
					yOffset += 60;
					labels.Add(new ClickableComponent(new Rectangle((int)((float)(xPositionOnScreen + width / 2) - Game1.smallFont.MeasureString(pet.name).X / 2f), yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + yOffset + 16, 1, 1), pet.Name));
					top = new Point(xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + 320 + 48 + IClickableMenu.borderWidth, yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + yOffset);
					top.X = xPositionOnScreen + width - IClickableMenu.spaceToClearSideBorder - IClickableMenu.borderWidth - 128;
					yOffset += 42;
					top = new Point(xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + 320 + 48 + IClickableMenu.borderWidth, yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + yOffset);
					top.X = xPositionOnScreen + width - IClickableMenu.spaceToClearSideBorder - IClickableMenu.borderWidth - 128;
					petPortraitBox = new Rectangle(xPositionOnScreen + width / 2 - 32, yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + yOffset, 64, 64);
				}
			}
