...
namespace StardewValley.Menus
{
	public class MapPage : IClickableMenu
	{
			...
			: base(x, y, width, height)
		{
			...
			string ccText = "";
			ccText = ((!Utility.doesMasterPlayerHaveMailReceivedButNotMailForTomorrow("ccMovieTheater") || !Utility.doesMasterPlayerHaveMailReceivedButNotMailForTomorrow("ccMovieTheaterJoja")) ? Game1.content.LoadString("Strings\\StringsFromCSFiles:MapPage.cs.11117") : (Game1.content.LoadString("Strings\\StringsFromCSFiles:MovieTheater_Map") + Environment.NewLine + Game1.content.LoadString("Strings\\StringsFromCSFiles:MovieTheater_Hours")));
			points.Add(new ClickableComponent(new Rectangle(mapX + 692, mapY + 204, 44, 36), ccText)
			{
				myID = 1032,
				downNeighborID = 1012,
				upNeighborID = 1022,
