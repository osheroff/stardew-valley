...
namespace StardewValley.Menus
{
	public class TitleMenu : IClickableMenu, IDisposable
	{
		...
		private void showButterflies()
		{
			...
			List<TemporaryAnimatedSprite> i = Utility.sparkleWithinArea(new Rectangle(width / 2 - 240 * zoom - 8 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 86 * zoom - 8 * zoom, 80, 64), 2, Color.White * 0.75f);
