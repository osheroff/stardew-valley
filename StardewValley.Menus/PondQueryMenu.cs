	...
	public class PondQueryMenu : IClickableMenu
	{
		...
		public override void draw(SpriteBatch b)
		{
			if (!Game1.globalFade)
			{
				...
				Utility.drawTextWithShadow(b, population_text, Game1.smallFont, new Vector2((float)(xPositionOnScreen + width / 2) - text_size.X * 0.5f, yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 16 + 128), Game1.textColor);
