...
namespace StardewValley.Menus
{
	public class PurchaseAnimalsMenu : IClickableMenu
	{
		...
		public static string getAnimalTitle(string name)
		{
			return name switch
			{
				"Chicken" => Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5922"), 
				"Duck" => Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5937"), 
				"Rabbit" => Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5945"), 
				"Dairy Cow" => Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5927"), 
				"Pig" => Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5948"), 
				"Goat" => Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5933"), 
				"Sheep" => Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5942"), 
				"Ostrich" => Game1.content.LoadString("Strings\\StringsFromCSFiles:Ostrich_Name"), 
				_ => "", 
			};
		}
