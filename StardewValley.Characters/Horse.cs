...
namespace StardewValley.Characters
{
	public class Horse : NPC
	{
		...
		public override void draw(SpriteBatch b)
		{
			...
			float horse_draw_layer = (float)GetBoundingBox().Center.Y / 10000f;
			if (rider != null)
			{
				horse_draw_layer = ((FacingDirection == 0) ? ((position.Y + 64f - 32f) / 10000f) : ((FacingDirection != 2) ? ((position.Y + 64f - 1f) / 10000f) : ((position.Y + 64f + (float)((rider != null) ? 1 : 1)) / 10000f)));
			}
			if (!draw_hat)
			{
				return;
			...
			case 5:
			case 6:
				hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(30f, -42f - ((rider != null) ? rider.yOffset : 0f))), 1.33333337f, 1f, horse_draw_layer, 2);
				break;
			case 7:
			case 11:
				if (flip)
				{
					hat.Value.draw(b, getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-14f, -74f), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(66f, -74f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 8:
				if (flip)
				{
					hat.Value.draw(b, getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-18f, -74f), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(70f, -74f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 9:
				if (flip)
				{
					hat.Value.draw(b, getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-18f, -70f), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(70f, -70f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 10:
				if (flip)
				{
					hat.Value.draw(b, getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-14f, -70f), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(66f, -70f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 12:
				if (flip)
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-14f, -78f)), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(66f, -78f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 13:
				if (flip)
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-18f, -78f)), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(70f, -78f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 21:
				if (flip)
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-14f, -66f)), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(66f, -66f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 22:
				if (flip)
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-18f, -54f)), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(70f, -54f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 23:
				if (flip)
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(-18f, -42f)), 1.33333337f, 1f, horse_draw_layer, 3);
				}
				else
				{
					hat.Value.draw(b, Utility.snapDrawPosition(getLocalPosition(Game1.viewport) + hatOffset + new Vector2(70f, -42f)), 1.33333337f, 1f, horse_draw_layer, 1);
				}
				break;
			case 24:
				if (flip)
			...
			case 20:
			case 25:
				hat.Value.draw(b, getLocalPosition(Game1.viewport) + hatOffset + new Vector2(28f, -106f - ((rider != null) ? rider.yOffset : 0f)), 1.33333337f, 1f, horse_draw_layer, 0);
				break;
			}
		}
	}
