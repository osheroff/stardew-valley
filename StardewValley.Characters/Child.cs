	...
	public class Child : NPC
	{
		...
		public override void dayUpdate(int dayOfMonth)
		{
			...
			if (base.Age == 3)
			{
				...
				else
				{
					...
					p = obj.GetChildBedSpot(GetChildIndex());
					if (!p.Equals(Point.Zero))
					{
						setTilePosition(p);
					}
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (draw_hat)
			{
				...
				hat.Value.draw(b, getLocalPosition(Game1.viewport) + hatOffset + new Vector2(30f, -42f), 1.33333337f, 1f, horse_draw_layer, direction);
			}
		}
