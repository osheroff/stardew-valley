...
namespace StardewValley.BellsAndWhistles
{
	public class ParrotPlatform
	{
		...
		public virtual void StartDeparture()
		{
			...
			event_string.Append("/0 0/farmer " + Game1.player.getTileX() + " " + Game1.player.getTileY() + " " + Game1.player.facingDirection);
			event_string.Append("/playerControl parrotRide");
			_takeoffEvent = new Event(event_string.ToString())
			{
