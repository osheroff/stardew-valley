...
namespace StardewValley.Objects
{
	public class TV : Furniture
	{
		...
		private string getIslandWeatherForecast()
		{
			...
			{
				0 => response + ((Game1.random.NextDouble() < 0.5) ? Game1.content.LoadString("Strings\\StringsFromCSFiles:TV.cs.13182") : Game1.content.LoadString("Strings\\StringsFromCSFiles:TV.cs.13183")), 
				1 => response + Game1.content.LoadString("Strings\\StringsFromCSFiles:TV.cs.13184"), 
				3 => response + Game1.content.LoadString("Strings\\StringsFromCSFiles:TV.cs.13185"), 
				_ => response + "???", 
			};
		}
		...
		protected virtual string getWeatherForecast()
		{
			...
			case 4:
			{
				...
				try
				{
					festivalData = Game1.temporaryContent.Load<Dictionary<string, string>>(string.Concat("Data\\Festivals\\" + Game1.currentSeason, Game1.dayOfMonth + 1));
				}
				catch (Exception)
				{
