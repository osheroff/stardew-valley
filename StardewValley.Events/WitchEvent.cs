...
namespace StardewValley.Events
{
	public class WitchEvent : FarmEvent, INetObject<NetFields>
	{
		...
		public void makeChangesToLocation()
		{
			...
			{
				Vector2 v = new Vector2(r.Next(2, targetBuilding.indoors.Value.Map.Layers[0].LayerWidth - 2), r.Next(2, targetBuilding.indoors.Value.Map.Layers[0].LayerHeight - 2));
