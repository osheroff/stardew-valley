...
namespace StardewValley.Locations
{
	public class Summit : GameLocation
	{
			...
			if (temporarySprites.Count == 0 && Game1.random.NextDouble() < ((Game1.timeOfDay < 1800) ? 0.0006 : ((Game1.currentSeason.Equals("summer") && Game1.dayOfMonth == 20) ? 1.0 : 0.001)))
			{
				...
				if (Game1.timeOfDay < 1800)
				{
					if (Game1.currentSeason.Equals("spring") || Game1.currentSeason.Equals("fall"))
					{
						...
						{
							TemporaryAnimatedSprite bird = new TemporaryAnimatedSprite("LooseSprites\\Cursors", sourceRect, Game1.random.Next(80, 121), 4, 200, startingPosition + new Vector2((k + 1) * Game1.random.Next(15, 18), (k + 1) * -20), flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
							{
								layerDepth = 0f
							};
							bird.motion = new Vector2(-1f, 0f);
							temporarySprites.Add(bird);
							bird = new TemporaryAnimatedSprite("LooseSprites\\Cursors", sourceRect, Game1.random.Next(80, 121), 4, 200, startingPosition + new Vector2((k + 1) * Game1.random.Next(15, 18), (k + 1) * 20), flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
							{
								layerDepth = 0f
							};
							bird.motion = new Vector2(-1f, 0f);
					...
					{
						TemporaryAnimatedSprite bird5 = null;
						bird5 = Game1.currentSeason switch
						{
							"spring" => new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Rectangle(0, 302, 26, 18), Game1.random.Next(80, 121), 4, 200, startingPosition, flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
							{
								layerDepth = 0f,
								pingPong = true
							}, 
							"summer" => new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(1, 165, 24, 21), Game1.random.Next(60, 80), 6, 200, startingPosition, flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
							{
								layerDepth = 0f
							}, 
							"fall" => new TemporaryAnimatedSprite("TileSheets\\critters", new Rectangle(0, 64, 32, 32), Game1.random.Next(60, 80), 5, 200, startingPosition, flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
							{
								layerDepth = 0f,
								pingPong = true
							}, 
							"winter" => new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Rectangle(104, 302, 26, 18), Game1.random.Next(80, 121), 4, 200, startingPosition, flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
							{
								layerDepth = 0f,
								pingPong = true
							}, 
					...
					else if (Game1.random.NextDouble() < 0.15 && Game1.stats.getStat("childrenTurnedToDoves") > 1)
					{
						for (int j = 0; j < Game1.stats.getStat("childrenTurnedToDoves"); j++)
						{
							...
							TemporaryAnimatedSprite bird4 = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(388, 1894, 24, 21), Game1.random.Next(80, 121), 6, 200, startingPosition + new Vector2((j + 1) * (Game1.random.Next(25, 27) * 4), Game1.random.Next(-32, 33) * 4), flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
							{
								layerDepth = 0f
							};
					...
					{
						sourceRect = Rectangle.Empty;
						TemporaryAnimatedSprite bird3 = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(222, 1890, 20, 9), 30f, 2, 99900, startingPosition, flicker: false, flipped: false, 0.01f, 0f, Color.White, 2f, 0f, 0f, 0f, local: true)
						{
							yPeriodic = true,
					...
					{
						sourceRect = Rectangle.Empty;
						TemporaryAnimatedSprite bird2 = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(206, 1827, 15, 25), 30f, 4, 99900, startingPosition, flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
						{
		...
		public string getEndSlideshow()
		{
			...
			i += 5000;
			sb.Append("spriteText 4 \"" + Utility.loadStringShort("UI", "EndCredit_Animals") + " \"/pause " + (i - oldTime + 22000));
			oldTime = i;
			foreach (KeyValuePair<string, string> v3 in Game1.content.Load<Dictionary<string, string>>("Data\\FarmAnimals"))
			{
				...
				base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(0, height, width, height), 120f, 1, 999999, new Vector2((float)(Game1.viewport.Width + animalWidth / 2) - Game1.dialogueFont.MeasureString(v3.Value.Split('/')[25]).X / 2f, (int)((float)Game1.viewport.Height * 0.5f + 12f)), flicker: false, flipped: true, 0.9f, 0f, Color.White, 1f, 0f, 0f, 0f, local: true)
				{
					motion = new Vector2(-3f, 0f),
					delayBeforeAnimationStart = i,
			...
			sb.Append("/spriteText 1 \"" + Utility.loadStringShort("UI", "EndCredit_Fish") + " \"/pause " + (i - oldTime + 18000));
			i += 6000;
			oldTime = i;
			...
			sb.Append("/spriteText 2 \"" + Utility.loadStringShort("UI", "EndCredit_Monsters") + " \"/pause " + (i - oldTime + 19000));
			i += 6000;
			oldTime = i;
			foreach (KeyValuePair<string, string> v in Game1.content.Load<Dictionary<string, string>>("Data\\Monsters"))
			{
				...
				case "Green Slime":
				{
					...
					base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t4.Width, spriteWidth * spriteStartIndex / t4.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2(Game1.viewport.Width + 192 - 64, (float)Game1.viewport.Height * 0.5f - (float)(spriteHeight * 4) + 32f), flicker: false, flipped: true, 0.9f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
					{
						motion = new Vector2(-3f, 0f),
						delayBeforeAnimationStart = i,
						yPeriodic = (animationLength == 1),
					...
					base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t4.Width, spriteWidth * spriteStartIndex / t4.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2((float)Game1.viewport.Width + 240f - 64f, (float)Game1.viewport.Height * 0.5f - (float)(spriteHeight * 4 * 2) + 32f), flicker: false, flipped: true, 0.9f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
					{
						motion = new Vector2(-3f, 0f),
						delayBeforeAnimationStart = i,
						yPeriodic = (animationLength == 1),
					...
					attachedCharacter = new GreenSlime(Vector2.Zero, 0);
					(attachedCharacter as GreenSlime).makeTigerSlime();
					base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t4.Width, spriteWidth * spriteStartIndex / t4.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2((float)Game1.viewport.Width + 144f - 64f, (float)Game1.viewport.Height * 0.5f - (float)(spriteHeight * 4 * 2) + 32f), flicker: false, flipped: true, 0.9f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
					{
						motion = new Vector2(-3f, 0f),
						delayBeforeAnimationStart = i,
						yPeriodic = (animationLength == 1),
				...
				{
					Texture2D t = null;
					t = ((attachedCharacter != null) ? attachedCharacter.Sprite.Texture : Game1.content.Load<Texture2D>("Characters\\Monsters\\" + v.Key));
