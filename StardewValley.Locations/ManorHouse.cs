...
namespace StardewValley.Locations
{
	public class ManorHouse : GameLocation
	{
		...
		{
			string prompt = "";
			prompt = ((!SpecialOrder.IsSpecialOrdersBoardUnlocked()) ? Game1.content.LoadString("Strings\\Locations:ManorHouse_LAF_Check") : Game1.content.LoadString("Strings\\Locations:ManorHouse_LAF_Check_OrdersUnlocked"));
		...
		public override bool answerDialogueAction(string questionAndAnswer, string[] questionParams)
		{
			...
			case "divorceCancel_Yes":
				if ((bool)Game1.player.divorceTonight)
				{
					...
					s = Game1.content.LoadStringReturnNullIfNotFound("Strings\\Locations:ManorHouse_DivorceBook_Cancelled_" + Game1.player.spouse);
					if (s == null)
					{
			...
			case "divorce_Yes":
				if (Game1.player.Money >= 50000 || Game1.player.spouse == "Krobus")
				{
					...
					s = Game1.content.LoadStringReturnNullIfNotFound("Strings\\Locations:ManorHouse_DivorceBook_Filed_" + Game1.player.spouse);
					if (s == null)
					{
			...
			{
				string s2 = questionAndAnswer.Split('_')[1];
				long id = 0L;
				if (long.TryParse(s2, out id))
				{
