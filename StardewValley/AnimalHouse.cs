...
namespace StardewValley
{
	public class AnimalHouse : GameLocation, IAnimalLocation
	{
		...
		protected override void resetSharedState()
		{
			...
			{
				if (!o.bigCraftable || !o.Name.Contains("Incubator") || o.heldObject.Value == null || (int)o.minutesUntilReady > 0)
				{
					continue;
				}
				if (!isFull())
		...
		public void addNewHatchedAnimal(string name)
		{
			...
			foreach (Object o in objects.Values)
			{
				if (!o.bigCraftable || !o.Name.Contains("Incubator") || o.heldObject.Value == null || (int)o.minutesUntilReady > 0 || isFull())
				{
					continue;
				}
				foundIncubator = true;
