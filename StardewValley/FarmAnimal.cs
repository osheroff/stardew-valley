	...
	public class FarmAnimal : Character
	{
		...
		public string displayHouse
		{
			get
			{
				...
				{
					Game1.content.Load<Dictionary<string, string>>("Data\\FarmAnimals").TryGetValue(type, out var rawData);
		...
		{
			Game1.content.Load<Dictionary<string, string>>("Data\\FarmAnimals").TryGetValue(type.Value, out var rawData);
			if (rawData != null)
			{
		...
		public string getMoodMessage()
		{
			...
			default:
				...
				{
					3 => Game1.content.LoadString("Strings\\FarmAnimals:MoodMessage_Sad", base.displayName), 
					2 => Game1.content.LoadString("Strings\\FarmAnimals:MoodMessage_Fine", base.displayName), 
					1 => Game1.content.LoadString("Strings\\FarmAnimals:MoodMessage_Happy", base.displayName), 
					_ => "", 
				};
			}
		}
		...
		{
			Vector2 tileLocation = new Vector2(currentPoint.x, currentPoint.y);
			if (location.terrainFeatures.TryGetValue(tileLocation, out var t) && t is Grass)
			{
