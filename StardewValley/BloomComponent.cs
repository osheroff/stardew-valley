...
namespace StardewValley
{
	public class BloomComponent : DrawableGameComponent
	{
		...
		protected override void LoadContent()
		{
			...
			sceneRenderTarget = new RenderTarget2D(base.GraphicsDevice, width, height, mipMap: false, format, pp.DepthStencilFormat, pp.MultiSampleCount, RenderTargetUsage.DiscardContents);
			width /= 2;
			height /= 2;
			renderTarget1 = new RenderTarget2D(base.GraphicsDevice, width, height, mipMap: false, format, DepthFormat.None);
			renderTarget2 = new RenderTarget2D(base.GraphicsDevice, width, height, mipMap: false, format, DepthFormat.None);
		}
